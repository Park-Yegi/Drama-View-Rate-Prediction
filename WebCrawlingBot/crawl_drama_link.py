...
year_list = ['2005년', '2006년', '2007년', '2008년', '2009년', '2010년', '2011년', '2012년', '2013년', '2014년', '2015년', '2016년', '2017년', '2018년', '2019년', '2020년']
year_list.reverse()
...
for year in year_list:
    ...
    year_xpath = "//li[@data-text='" + year + "']/a"
    ...
    for i in range(1, page_number+1):
        drama_list = body.find('div', {'id':'mflick'}).select('div > div > ul')[i-1].select('li.info_box')
    ...
    # scroll down
    year_xpath = "//li[@data-text='" + year_list[k+2] + "']/a"
    each_year_button = browser.find_element_by_xpath(year_xpath)
    action = webdriver.ActionChains(browser)
    action.move_to_element(each_year_button).perform()
    time.sleep(2)
    k += 1
